...
3. mentions: PEOPLE (or specific internal teams like "security team") referred to
   ...
   team label), the id of who said it, and brief context. Never include companies,
   products, tools, places, certifications, documents, or pronoun-only references
   ("she", "my team"). Never include someone who IS a participant.
